...
public class testOur_RenameStaticMethod_ForEclipseTests extends RenameTestCase {

    public testOur_RenameStaticMethod_ForEclipseTests(String name) throws Exception {
        super(name);
        setArgsFromFile(testOur_RenameStaticMethod_ForEclipseTests.class.getSimpleName(), "eclipseTest");
    }
    
    public static NbTestSuite suite() {
        return new NbTestSuite(testOur_RenameStaticMethod_ForEclipseTests.class);
    }
