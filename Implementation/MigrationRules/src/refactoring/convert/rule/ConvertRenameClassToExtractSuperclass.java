...
public class ConvertRenameClassToExtractSuperclass {
	public static void convertRenameClassToExtractSuperclass(IProject project, List<IFile> javaFiles,
			IFile testCaseFile, CompilationUnit cu, String oldClassName, String newClassName)
...
//									System.out.println(modifiedSourceCode);
					SaveFile.saveContentToFile(Constant.CONVERT_PROGRAM_SAVE_PATH + "renameClassToExtractSuperclass/"
							+ "Bug" + oldClassName + ".java", modifiedSourceCode);
