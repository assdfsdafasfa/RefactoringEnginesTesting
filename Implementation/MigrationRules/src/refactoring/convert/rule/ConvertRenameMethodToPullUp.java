...
public class ConvertRenameMethodToPullUp {
	// 过度转换，先将rename 转化为 move , 再将move 转化pull down
	public void convertRenameMethodToPullUp(IProject project, List<IFile> javaFiles, IFile testCaseFile,
...
//										System.out.println(modifiedSourceCode);
					SaveFile.saveContentToFile(
							Constant.CONVERT_PROGRAM_SAVE_PATH + "ConvertRenameMethodToPullUp/" + "Bug" + fileName
									+ ".java",
							modifiedSourceCode);
				}
			}
