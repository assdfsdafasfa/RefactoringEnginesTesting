...
public class ConvertExtractFieldToRename {
	public static void convertExtractFieldToRename(IProject project, List<IFile> javaFiles, IFile testCaseFile,
	    ...
	    private static void performExtractField(CompilationUnit cu, VariableDeclarationStatement targetNode) {
	        ...
	        ((VariableDeclaration) newField.fragments().get(0)).setInitializer((Expression) ASTNode.copySubtree(ast, initializer));
