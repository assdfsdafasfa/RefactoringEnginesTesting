...
public class ConvertMoveMethodToInline {
	public void convertMoveMethodToInline(IProject project, List<IFile> javaFiles, IFile testCaseFile,
						...
						cu.accept(new ASTVisitor() {
							...
							public boolean visit(TypeDeclaration node) {
								if (((TypeDeclaration) node).getName().toString().equals(targetClass)) {
									((TypeDeclaration) node).bodyDeclarations().add(methodDeclaration);
									try {
...
//										System.out.println(modifiedSourceCode);
										SaveFile.saveContentToFile(Constant.CONVERT_PROGRAM_SAVE_PATH
												+ "convertMoveMethodToInline/" + "Bug" + sourceClass + ".java",
												modifiedSourceCode);
...
//										System.out.println(modifiedSourceCode);
										SaveFile.saveContentToFile(Constant.CONVERT_PROGRAM_SAVE_PATH
												+ "convertMoveMethodToInline/" + sourceClass + ".java",
												modifiedSourceCode);
