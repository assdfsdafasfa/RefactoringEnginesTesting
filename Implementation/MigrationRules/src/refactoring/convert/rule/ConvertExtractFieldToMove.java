...
public class ConvertExtractFieldToMove {
	public static void convertExtractFieldToMove(ICompilationUnit sourceUnit, CompilationUnit sourceAST,
			String fieldName, String targetPackageName) {
		try {
