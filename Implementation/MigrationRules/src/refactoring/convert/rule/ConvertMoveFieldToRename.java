...
public class ConvertMoveFieldToRename {
	Type fieldType = null;

	public void convertMoveFieldToRename(IProject project, List<IFile> javaFiles, IFile testCaseFile,
		...
		for (Object type : cu.types()) {
			...
			if (type instanceof TypeDeclaration) {
				...
				if (typeDeclaration.getName().toString().equals(targetClass) && fieldType != null) {
...
//									System.out.println(modifiedSourceCode);
					SaveFile.saveContentToFile(
							Constant.CONVERT_PROGRAM_SAVE_PATH + "convertMoveFieldToRename/" + "Bug" + sourceClass
									+ ".java",
							modifiedSourceCode);
