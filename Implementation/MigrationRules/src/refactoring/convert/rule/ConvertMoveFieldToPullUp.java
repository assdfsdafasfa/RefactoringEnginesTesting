...
public class ConvertMoveFieldToPullUp {
	public void convertMoveFieldToPullUp(IProject project, List<IFile> javaFiles, IFile testCaseFile,
		...
		for (Object type : cu.types()) {
			...
			if (type instanceof TypeDeclaration) {
				...
				if (typeDeclaration.getName().toString().equals(targetClass)) {
					SimpleName superclassTypeName = cu.getAST().newSimpleName(sourceClass);// ------------------------------------
...
//										System.out.println(modifiedSourceCode);
					SaveFile.saveContentToFile(
							Constant.CONVERT_PROGRAM_SAVE_PATH + "convertMoveFieldToPullUp/" + "Bug" + sourceClass
									+ ".java",
							modifiedSourceCode);
				}
			}
