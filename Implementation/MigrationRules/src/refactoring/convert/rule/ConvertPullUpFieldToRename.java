...
public class ConvertPullUpFieldToRename {
	Type fieldType = null;
	String parentClassName = "";

	public void convertPullUpFieldToRename(IProject project, List<IFile> javaFiles, IFile testCaseFile,
...
//									System.out.println(modifiedSourceCode);
					SaveFile.saveContentToFile(
							Constant.CONVERT_PROGRAM_SAVE_PATH + "convertPullUpFieldToRename/" + "Bug" + sourceClass
									+ ".java",
							modifiedSourceCode);
