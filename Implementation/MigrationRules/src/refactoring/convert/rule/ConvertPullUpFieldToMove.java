...
public class ConvertPullUpFieldToMove {
	public static void convertPullUpFieldToMove(IProject project, List<IFile> javaFiles, IFile testCaseFile,
...
//						System.out.println(modifiedSourceCode);
		SaveFile.saveContentToFile(
				Constant.CONVERT_PROGRAM_SAVE_PATH + "convertPullUpFieldToMove/" + "Bug" + sourceName + ".java",
				modifiedSourceCode);
