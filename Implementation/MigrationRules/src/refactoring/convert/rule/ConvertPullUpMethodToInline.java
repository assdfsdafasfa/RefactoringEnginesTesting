...
public class ConvertPullUpMethodToInline {
	String parentClassName = "";

	public void convertPullUpMethodToInline(IProject project, List<IFile> javaFiles, IFile testCaseFile,
		...
		for (Object type : cu.types()) {
			if (type instanceof TypeDeclaration) {
				...
				if (!parentClassName.equals("") && typeDeclaration.getName().toString().equals(parentClassName)) {
					AST ast = cu.getAST();
...
//							System.out.println(modifiedSourceCode);
							SaveFile.saveContentToFile(
									Constant.CONVERT_PROGRAM_SAVE_PATH + "moveToInlineMethod/" + "Bug" + sourceClass
											+ ".java",
									modifiedSourceCode);
